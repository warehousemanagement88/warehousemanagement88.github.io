...
<a type="button" href="detail_staff.html?staffId=#DETAIL#" class="text-xs font-semibold leading-tight text-slate-400"> <i class="fas fa-info-circle"></i> Detail</a>
<a type="button" href="edit_staff.html?staffId=#EDIT#" class="text-xs font-semibold leading-tight text-slate-400"> <i class="fas fa-edit"></i> Edit</a>
</button>
</tr>
`;
